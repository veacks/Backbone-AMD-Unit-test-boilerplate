define ["underscore"], (_) ->
	...
	App.Config = _.extend(App.Config, {
		...
		dataPaths :
		  concessions : "concessions.json"
		  brand_collection : "listBrandMoto.json"
		  moto_collection : "tempMotoList.json"
		  modelsBMW : "BMW_motos.json"

		#External Api Keys configuration
		keys :
		  gMap : "AIzaSyB4O0CHTTRJyNIzEFHQ5VHTJK9hUb7m_3Y"
		  facebook : '365654783508199'
		  gAnalytics : 'UA-39293881-1'
	})
	...
	App.Config = _.extend(App.Config, {
		...
		extPaths :
		  gMap : "http://maps.googleapis.com/maps/api/js?key="+App.Config.keys.gMap+"&sensor=true"
		  BmwApi : "https://api.motobmw.fr/"
	})
	...
	require.config 
	  paths:
	    ...
	    # Jquery plugins
	    #jTransform : "plugins/jquery/jquery-css-transform"
	    #jMouseWheel : "plugins/jquery/vitch-jScrollPane/script/jquery.mousewheel"
	    #jScrollPane : "plugins/jquery/vitch-jScrollPane/script/jquery.jscrollpane.min"
	    #jValidate : "plugins/jquery/jquery.validate"

	    # tQuery
	    tQuery : "libs/tquery/tquery-bundle"
	    tQueryPlugs : "plugins/tquery/"
	    
	    #Gmap Plugins
	    #infobox : "plugins/gMap/infobox"
	...
	#Config require for tquery Plugins
	requirejs.config({
		"paths":
			#"build": "../../../build"
			"plugins": "plugins/tquery"
			"threex": "libs/threex"
